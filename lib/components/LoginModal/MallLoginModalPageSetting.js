...
var MallLoginModalPageSetting = function (_React$Component) {
    (0, _inherits3.default)(MallLoginModalPageSetting, _React$Component);

    function MallLoginModalPageSetting(props) {
        (0, _classCallCheck3.default)(this, MallLoginModalPageSetting);

        // const url = parse(props.location.search, true);
        // const { uri } = url.query;
        var _this = (0, _possibleConstructorReturn3.default)(this, (MallLoginModalPageSetting.__proto__ || (0, _getPrototypeOf2.default)(MallLoginModalPageSetting)).call(this, props));
        ...
        _this.onLogin = function () {
            ...
            dispatch({ type: 'loginPageSetting/touristlogin', payload: postD });
        };
        ...
        _this.sendSmsCode = function () {
            ...
            dispatch({ type: 'loginPageSetting/getCode', payload: postD });
        };
    ...
    (0, _createClass3.default)(MallLoginModalPageSetting, [{
        key: 'componentWillReceiveProps',
        value: function componentWillReceiveProps(nextProps) {
            var props = this.props;
            var _nextProps$loginPageS = nextProps.loginPageSetting,
                touristlogin = _nextProps$loginPageS.touristlogin,
                getCode = _nextProps$loginPageS.getCode;

            if (getCode !== props.loginPageSetting.getCode) {
            ...
            // 登录成功
            if (touristlogin !== this.props.loginPageSetting.touristlogin) {
    ...
    return MallLoginModalPageSetting;
}(_react2.default.Component);

var mapStateToProps = function mapStateToProps(state) {
    return (0, _extends3.default)({}, state);
};
exports.default = (0, _dva.connect)(mapStateToProps)((0, _rcForm.createForm)()(MallLoginModalPageSetting));