...
var LoginPageModal = function (_React$Component) {
  (0, _inherits3.default)(LoginPageModal, _React$Component);

  function LoginPageModal(props) {
    (0, _classCallCheck3.default)(this, LoginPageModal);

    // const url = parse(props.location.search, true);
    // const { uri } = url.query;
    var _this = (0, _possibleConstructorReturn3.default)(this, (LoginPageModal.__proto__ || (0, _getPrototypeOf2.default)(LoginPageModal)).call(this, props));
  ...
  (0, _createClass3.default)(LoginPageModal, [{
...
exports.default = (0, _dva.connect)(mapStateToProps)((0, _rcForm.createForm)()(LoginPageModal));