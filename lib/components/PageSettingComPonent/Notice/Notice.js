      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            jumpStyle === 'rightIco' && _react2.default.createElement(_icon2.default, { type: 'right', className: 'tips-icon right-ico',
              style: { position: 'absolute', right: '18px' }, onClick: function onClick() {
                return _this2.toUrl(linkurl);
              } }),
            jumpStyle === 'closeIco' && _react2.default.createElement('img', { src: require('../imgs/close.png'), style: { position: 'absolute', right: '18px', cursor: 'pointer' },
              onClick: this.deleteInfo })
          ),
          _react2.default.createElement(
            'div',
            { ref: 'scroll_div', className: 'scroll_div', style: { width: '6.5rem' } },
            _react2.default.createElement(
              'div',
