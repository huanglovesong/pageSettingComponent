...
var FlashSale = function (_React$Component) {
  ...
  function FlashSale() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = FlashSale.__proto__ || (0, _getPrototypeOf2.default)(FlashSale)).call.apply(_ref, [this].concat(args))), _this), _this.toList = function (mid) {
      // 友盟埋点限时抢购点击
      _this.props.clickUmBuired('组件-限时抢购', '更多');
      _this.props.history.push('/list?mid=' + mid);
    }, _this.toDetail = function (gid, pid, pname) {
      // 友盟埋点限时抢购点击
      _this.props.clickUmBuired('组件-限时抢购', pname);
      _this.props.history.push('/detail?gid=' + gid + (pid ? '&pid=' + pid : ''));
    }, _this.getPrice = function (item) {
      var priceArr = item.price ? item.price.toString().split(".") : [];
      ...
      if (!item.moduleDataList.length) {
        ...
        var _item$modelStyle$flas = item.modelStyle.flashSaleStyleModel,
            ...
            topMargin = _item$modelStyle$flas.topMargin,
            bottomMargin = _item$modelStyle$flas.bottomMargin,
            borderRadius = _item$modelStyle$flas.borderRadius;
        ...
        var style = { paddingTop: topMargin / 50 + 'rem', paddingBottom: (bottomMargin === null ? 5 : bottomMargin) / 50 + 'rem' };
        var shopInfo = localStorage.getItem('shopInfo') ? JSON.parse(localStorage.getItem('shopInfo')) : {};
        return _react2.default.createElement(
          'div',
          { className: 'flash-sale-box clearfix', style: style },
          _react2.default.createElement(
            'div',
            { className: 'goods-bg' },
            _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              item.moduleDataList[0] && _react2.default.createElement(
                ...
                item.moduleDataList[0].dataDetailCacheModels.map(function (item) {
                  return _react2.default.createElement(
                    'div',
                    { className: 'scroll-div-item_H item', style: { borderRadius: (borderRadius === null ? 8 : borderRadius) / 50 + 'rem' },
                      onClick: function onClick() {
                        _this.toDetail(item.childCategoryId, item.productId, item.productName);
                      } },
