...
var Coupons = (_temp = _class = function (_Component) {
    ...
    function Coupons(props) {
        ...
        _this2.cardActivityOvered = function (merCouponId) {
            // 友盟埋点优惠券点击
            _this2.props.clickUmBuired('组件-优惠券');
            _this2.setState({
        ...
        _this2.getCom = function () {
            ...
            if (len) {
                ...
                var _item$modelStyle$coup = item.modelStyle.couponStyleModel,
                    displayStyle = _item$modelStyle$coup.displayStyle,
                    pageMargin = _item$modelStyle$coup.pageMargin,
                    template = _item$modelStyle$coup.template,
                    topMargin = _item$modelStyle$coup.topMargin,
                    bottomMargin = _item$modelStyle$coup.bottomMargin;
                ...
                if (template === 'one') {
                    customEle = item.moduleDataList.map(function (item) {
                        return _react2.default.createElement(
                            'div',
                            { className: 'coupons-box-img ' + template + '-module ' + template + '-module-' + displayStyle + ' float-left',
                ...
                // 一行多个
                        ...
                        var oneWidth = (375 - pageMargin + _margin * 2) / 3;
