...
var ExchangePage = (_temp = _class = function (_React$Component) {
    (0, _inherits3.default)(ExchangePage, _React$Component);

    function ExchangePage(props) {
        (0, _classCallCheck3.default)(this, ExchangePage);

        var _this = (0, _possibleConstructorReturn3.default)(this, (ExchangePage.__proto__ || (0, _getPrototypeOf2.default)(ExchangePage)).call(this, props));
    ...
    (0, _createClass3.default)(ExchangePage, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                shopInfo.merInfoTemplates.visitType != 3 && _react2.default.createElement('div', { className: 'listicon', onClick: function onClick() {
                        _this3.props.history.push('./orderlist');
                    } }),
                _react2.default.createElement('div', { className: 'serviceicon', onClick: function onClick() {
                        _this3.props.history.push('./service');
                    } })
            );
        }
    }]);
    ...
    this.getPage = function () {
        var pageId = _this4.state.pageId;
        var pageType = _this4.props.pageType;
    ...
    this.getCom = function () {
        var allInfo = _this4.state.allInfo;

        var arr = [];
        var shopInfo = localStorage.getItem('shopInfo') ? JSON.parse(localStorage.getItem('shopInfo')) : {};
        var visitType = shopInfo.merInfoTemplates.visitType;

        allInfo.pageModuleList.map(function (item, index) {
            // banner轮播
            if (item.moduleType === 'bannerRoll') {
                arr.push(_react2.default.createElement(_BannerShuffling2.default, { item: item, history: _this4.props.history }));
            }
            // banner广告
            else if (item.moduleType === 'banner') {
                    arr.push(_react2.default.createElement(_BannerAdvertising2.default, { item: item, history: _this4.props.history }));
                }
                // 分类
                else if (item.moduleType === 'class') {
                        arr.push(_react2.default.createElement(_Classification2.default, { item: item, history: _this4.props.history }));
                    }
                    // 限时抢购
                    else if (item.moduleType === 'flashSale') {
                            arr.push(_react2.default.createElement(_FlashSale2.default, { item: item, history: _this4.props.history }));
                        }
                        // 图文导航
                        else if (item.moduleType === 'imageText') {
                                arr.push(_react2.default.createElement(_ImageText2.default, { item: item, history: _this4.props.history }));
                            }
                            // 图文导航
                            else if (item.moduleType === 'notice') {
                                    arr.push(_react2.default.createElement(_Notice2.default, { item: item, history: _this4.props.history }));
                                }
                                // 优惠券
                                else if (item.moduleType === 'coupon') {
                                        arr.push(_react2.default.createElement(_Coupons2.default, { item: item, history: _this4.props.history, componentIndex: index,
                                            authorizationFailurePageSetting: _this4.authorizationFailurePageSetting }));
                                    }
                                    // 兑换
                                    else if (item.moduleType === 'exchange') {
                                            arr.push(_react2.default.createElement(_Exchange2.default, { item: item, history: _this4.props.history, componentIndex: index,
                                                authorizationFailurePageSetting: _this4.authorizationFailurePageSetting }));
                                        }
                                        // 登录并且不是游客   showLoginModal只登录
                                        else if (item.moduleType === 'touristLogin' && visitType !== 3) {
                                                arr.push(_react2.default.createElement(_TouristLogin2.default, { item: item, history: _this4.props.history, componentIndex: index,
                                                    authorizationFailurePageSetting: _this4.authorizationFailurePageSetting, showLoginModal: _this4.showLoginModal }));
                                            }
                                            // 富文本编辑
                                            else if (item.moduleType === 'richText') {
                                                    arr.push(_react2.default.createElement(_RichText2.default, { item: item, history: _this4.props.history, componentIndex: index }));
                                                }
        });
        return arr;
    };

    this.authorizationFailurePageSetting = function (componentIndex) {
        _this4.setState({
            componentIndex: componentIndex
        }, function () {
            (0, _auth.authorizationFailurePageSetting)(_this4);
        });
    };
    ...
    this.hideModal = function () {
        ...
        _this4.setState({ allInfo: allInfo });
    };

    this.loginSuccess = function (data) {
        var componentIndex = _this4.state.componentIndex;
        ...
        // setTimeout(() => {
        _this4.props.dispatch({ type: 'pageSetting/commonRequest', payload: { guid: Math.random(), componentIndex: componentIndex } });
        // }, 1000);
    };

    this.showLoginModal = function (componentIndex) {
        _this4.setState({
...
exports.default = (0, _dva.connect)(mapStateToProps)(ExchangePage);