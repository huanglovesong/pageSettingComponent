...
var ClassificationBox = (_temp = _class = function (_Component) {
  ...
  this.toDetail = function (gid, pid) {
    // 友盟埋点二级分类点击
    _this2.props.clickUmBuired("二级分类");
  ...
  this.getDelPrice = function (item) {
    var price = item.isCouponAfterPrice && item.couponBatchid ? item.couponAfterPrice : item.price;
      ...
      tabsStyle2HtmlArr.push(_react2.default.createElement(
        "div",
        {
          ...
          onClick: function onClick() {
            return _this2.renderContentStyle2(item, index);
          }
        },
  ...
  this.renderContentStyle1 = function (tabsItem) {
    ...
    var imageSource = item.modelStyle.classStyleModel.imageSource;
    // 商品高度
          ...
          return _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement("img", {
                  src: imageSource && imageSource === "product" ? item.productImage : item.iconPath
                })
              ),
              _react2.default.createElement(
                "div",
  ...
  this.waterFlow = function () {
    ...
    setTimeout(function () {
      ...
      var afterChangePageMargin = _mathManage2.default.accDiv(item.modelStyle.classStyleModel.pageMargin, _mathManage2.default.accDiv(100, fontSize));
      // 商品间距
      var productMargin = item.modelStyle.classStyleModel.productMargin / 2;
      // 页面边距
      var pageMargin = item.modelStyle.classStyleModel.pageMargin / 2;
      console.log(productMargin, pageMargin, 222211);
      var id = "class-content";
      // 1- 确定列数  = 页面的宽度 / 图片的宽度
      var itemWidth = 165;
      ...
      for (var i = 0; i < items.length; i++) {
        if (i < columns) {
          ...
          document.getElementById(id).style.height = (items[i].offsetHeight + pageMargin) / 50 + "rem";
        } else {
          // 其他行
          // 3- 找到数组中最小高度  和 它的索引
          var minHeight = arr[0];
          ...
          if (i === items.length - 1) {
            document.getElementById(id).style.height = (arr[index] + afterChangePageMargin) / fontSize + (items[i].offsetHeight + afterChangePageMargin) / fontSize + "rem";
          }
          // 5- 修改最小列的高度
          ...
          tabsItem.dataDetailCacheModels.map(function (item, index) {
            return _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                item.isCouponAfterPrice && item.couponBatchid && _react2.default.createElement(
                  "div",
                  { className: "status-content" },
                  _react2.default.createElement("div", { className: "discount-price-img" })
                ),
                _react2.default.createElement(
                  "div",
                  { className: "price" },
