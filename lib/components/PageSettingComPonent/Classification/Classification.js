...
var ClassificationBox = (_temp = _class = function (_Component) {
  ...
  this.getPrice = function (item) {
    ...
    if (!priceArr.length) return _react2.default.createElement(
      _react.Fragment,
      null,
  ...
  this.getCom = function () {
    ...
    if (!len) {
      ...
      var _item$modelStyle$clas2 = item.modelStyle.classStyleModel,
          pageMargin = _item$modelStyle$clas2.pageMargin,
          topMargin = _item$modelStyle$clas2.topMargin,
          bottomMargin = _item$modelStyle$clas2.bottomMargin;
