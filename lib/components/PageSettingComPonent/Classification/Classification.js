...
var ClassificationBox = (_temp = _class = function (_Component) {
  ...
  this.getTabsHeader = function () {
    ...
    item.moduleDataList.map(function (item, index) {
      tabsHtmlArr.push(_react2.default.createElement(
        "div",
        {
  ...
  this.renderContentStyle2 = function (tabsItem, clickTabBarIndex) {
    _this2.setState({
      ...
      var nowHtml = _this2.renderContent(tabsItem, clickTabBarIndex);
      var tabsHtml = [];
      tabsHtml.push(nowHtml);
      _this2.setState({ tabsHtml: tabsHtml });
    });
  };
  ...
  this.getCom = function () {
    ...
    if (!len) {
      ...
      var tabsHtml = _this2.state.tabsHtml;
