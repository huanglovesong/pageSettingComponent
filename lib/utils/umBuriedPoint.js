...
var homeBuriedPoin = {
    ...
    pageLoadDetail: function pageLoadDetail() {
        ...
        fl_cnzz.push(["_trackEvent", obj.productName || '', 'Um_Event_ItemDetail', um_key_userid, obj.proInfoId || obj.productId || '']);
    },
    ...
    pageLoadPaySuccess: function pageLoadPaySuccess() {
        ...
        // 友盟埋点 category action label value
        fl_cnzz.push(["_trackEvent", obj.productName || '', 'Um_Event_OrderResult', true, obj.proInfoId || obj.productId || '']);
    },
    ...
    pageLoadOrderStatus: function pageLoadOrderStatus() {
        ...
        var ordetStatusObj = {
            11: '待付款', 12: '扣款失败', 15: '交易关闭', 21: '充值中',
            31: '充值中', 41: '充值中', 51: '充值成功', 61: '充值失败', 71: '退款已到账'
        };
        // console.log('确认订单页-去支付-点击');
        // 友盟埋点 category action label value
        fl_cnzz.push(["_trackEvent", obj.productName || '', 'Um_Event_Payorder', ordetStatusObj[obj.orderStatus], obj.proInfoId || obj.productId || '']);
    }
};
...
var detailBuriedPoin = {
    ...
    detailPageBuyRIghtAway: function detailPageBuyRIghtAway() {
        ...
        // 友盟埋点 category action label value
        fl_cnzz.push(["_trackEvent", obj.productName || '', 'Um_Event_ExchangeNow', obj.activityId || '', obj.proInfoId || obj.productId || '']);
    }
};
// 确认订单页
var sureOrderBuriedPoin = {
    ...
    sureOrderPageToPay: function sureOrderPageToPay() {
        ...
        // 友盟埋点 category action label value
        fl_cnzz.push(["_trackEvent", obj.productName || '', 'Um_Event_SubmitOrder', obj.is_success || false, obj.proInfoId || obj.productId || '']);
    },
