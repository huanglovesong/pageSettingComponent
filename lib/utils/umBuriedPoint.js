...
var commonBuriedPoin = {
  cnzzUpload: function cnzzUpload() {
    var um_key_page_type = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
    var um_key_action = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
    var um_key_bit_type = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '';
    var um_key_value = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : '';
  ...
  // 友盟埋点，运营位点击
  operationBitClick: function operationBitClick() {
    var um_key_page_type = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
    var um_key_bit_type = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
    var um_key_value = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '';
  ...
  switchTab: function switchTab() {
    var um_key_buttonname = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';

    var userInfo = localStorage.getItem('userInfo') ? JSON.parse(localStorage.getItem('userInfo')) : {};
    var um_key_userid = userInfo.fuluId || '';
    // 友盟埋点 category action label
...
var homeBuriedPoin = {
  // 首页 icon点击（点击一级分类）
  clickOneProClassList: function clickOneProClassList() {
    var obj = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  ...
  // 点击导航栏切换首页
  switchTabHome: function switchTabHome() {
    // 点击导航栏切换
    commonBuriedPoin.switchTab('首页');
  },
  // 点击导航栏切换我的
  switchTabMy: function switchTabMy() {
    // 点击导航栏切换
    commonBuriedPoin.switchTab('我的');
  },
  // 首页-顶部banner点击
  homeTopBannerClick: function homeTopBannerClick() {
    var obj = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  ...
  // 首页-横通广告点击
  homeActiveBannerClick: function homeActiveBannerClick() {
    var obj = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  ...
  // 首页-瀑布流-分类点击
  homeProClassListClick: function homeProClassListClick() {
    var obj = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  ...
  // 首页-瀑布流-商品点击
  homeProClassProductClick: function homeProClassProductClick() {
    var obj = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  ...
  // 首页-限时抢购1-商品点击
  homeFlashSaleFirstClick: function homeFlashSaleFirstClick() {
    var obj = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  ...
  // 首页-限时抢购2-商品点击
  homeFlashSaleSecondClick: function homeFlashSaleSecondClick() {
    var obj = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  ...
  pageLoad: function pageLoad() {
    var um_key_pagecategory = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';

    // 来源页面
    var um_key_sourcepage = localStorage.getItem('commodity_detail_souce') || '';
    // 友盟埋点 category action label
    fl_cnzz.push(["_trackEvent", um_key_pagecategory, '页面浏览', um_key_sourcepage]);
  },

  // 页面加载二期
  pageLoadSecond: function pageLoadSecond(um_key_pagecategory, um_key_label, um_key_value) {
    // 友盟埋点 category action label
    fl_cnzz.push(["_trackEvent", um_key_pagecategory, '页面加载', um_key_label, um_key_value]);
  },
  pageLoadDetail: function pageLoadDetail() {
    var obj = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

    var userInfo = localStorage.getItem('userInfo') ? JSON.parse(localStorage.getItem('userInfo')) : {};
    var um_key_userid = userInfo.fuluId || '';
    // 友盟埋点 category action label value
    fl_cnzz.push(["_trackEvent", obj.productName || '', '查看商品详情', um_key_userid, obj.proInfoId || obj.productId || '']);
  },

  // 订单结果页-加载
  pageLoadPaySuccess: function pageLoadPaySuccess() {
    var obj = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

    // 友盟埋点 category action label value
    fl_cnzz.push(["_trackEvent", obj.productName || '', '订单结果页', true, obj.proInfoId || obj.productId || '']);
  },

  // 支付详情页-加载
  pageLoadOrderStatus: function pageLoadOrderStatus() {
    var obj = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    ...
    // 友盟埋点 category action label value
    fl_cnzz.push(["_trackEvent", obj.productName || '', '支付订单详情', ordetStatusObj[obj.orderStatus], obj.proInfoId || obj.productId || '']);
  }
};
...
var detailBuriedPoin = {
  // 立即兑换
  detailPageBuyRIghtAway: function detailPageBuyRIghtAway() {
    var obj = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

    // 友盟埋点 category action label value
    fl_cnzz.push(["_trackEvent", obj.productName || '', '立即兑换', obj.activityId || '', obj.proInfoId || obj.productId || '']);
  }
};
// 确认订单页
var sureOrderBuriedPoin = {
  // 去支付
  sureOrderPageToPay: function sureOrderPageToPay() {
    var obj = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

    // 友盟埋点 category action label value
    fl_cnzz.push(["_trackEvent", obj.productName || '', '去支付', obj.is_success || false, obj.proInfoId || obj.productId || '']);
  },
...
exports.commonBuriedPoin = commonBuriedPoin;
exports.pageLoadPoin = pageLoadPoin;
exports.detailBuriedPoin = detailBuriedPoin;
exports.sureOrderBuriedPoin = sureOrderBuriedPoin;
exports.homeBuriedPoin = homeBuriedPoin;