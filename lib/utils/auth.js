      ...
      // 第三方登录
          ...
          if (shopInfo.codeKey.toLowerCase() === (configs.UnionPay ? configs.UnionPay.toLowerCase() : '')) {
            ...
            // 否则进行联登
                ...
                alert('https://open.95516.com/s/open/html/oauth.html?appId=' + configs.UnionPayAppId + '&redirectUri=' + (phonetype === '1' ? REDIRECTURI : encodeURI(REDIRECTURI)) + '&responseType=code&scope=upapi_base');
