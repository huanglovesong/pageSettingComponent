...
app.model(_loginPageSetting2.default);
app.model(_exchange2.default);
...
(function () {
  ...
  if (module.hot) {
    var _modelNamespaceMap10 = {};

    var _model20 = require('./models/loginPageSetting');

    if (_model20.default) _model20 = _model20.default;
    _modelNamespaceMap10['./models/loginPageSetting'] = _model20.namespace;
    module.hot.accept('./models/loginPageSetting', function () {
      try {
        app.unmodel(_modelNamespaceMap10['./models/loginPageSetting']);

        var _model21 = require('./models/loginPageSetting');

        if (_model21.default) _model21 = _model21.default;
        app.model(_model21);
      } catch (e) {
        console.error(e);
      }
  ...
  if (module.hot) {
    var _modelNamespaceMap11 = {};

    var _model22 = require('./models/exchange');

    if (_model22.default) _model22 = _model22.default;
    _modelNamespaceMap11['./models/exchange'] = _model22.namespace;
    module.hot.accept('./models/exchange', function () {
      try {
        app.unmodel(_modelNamespaceMap11['./models/exchange']);

        var _model23 = require('./models/exchange');

        if (_model23.default) _model23 = _model23.default;
        app.model(_model23);
      } catch (e) {
        console.error(e);
      }
