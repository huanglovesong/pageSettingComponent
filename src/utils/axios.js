...
function getUrl(config) {
  ...
  const commonApiUrl = [];
  const openApiUrl = ['/api/Advertisement/GetBanner', '/api/Category/GetCategory', '/api/Category/GetChildCategory', '/api/Product/GetProductList',
    '/api/Product/GetProductTemp', '/api/Other/Verificationcode', '/api/Other/Touristlogincode', '/api/Product/GetProductTemp',
    '/api/Product/GetProductActivity', '/api/Order/SendOrder', '/api/Order/SendCardOrder', '/api/Order/GetOrderList', '/api/Order/GetOrderDetail',
    '/api/Order/ExtractCard', '/api/Product/GetPassCode', '/api/Product/GetPassCodeStatus', '/api/Category/RecommendCategory', '/api/Product/GetProductInfo',
    '/api/Category/GetHotCategory','/api/Mi/GetLuckDrawOrder','/api/Mi/PrizeNum','/api/Mi/PostLuckDrawOrder','/api/Mi/GetPrizeList','/api/Mi/MerDrawnList',
  '/api/Mi/DrawnList','/api/Mi/GetEventList','/api/Mi/PostDraw','/api/Mi/DrawnList','/api/Mi/PostDrawnWinning','/api/Mi/QueryDrawnWinning','/api/Mi/AddDrawCout',
    '/api/Category/GetHotCategory', '/api/Page/GetPage','/api/MerCouponActivity/CardActivityOvered','/api/MerCouponActivity/ObtainCard',
  '/api/MerCouponActivity/GetProInfoDetailCouponList','/api/MerCouponActivity/GetUserCouponList','/api/MerCouponActivity/GetOrderDetailsCouponList',
  '/api/MerCouponActivity/GetCouponProductList','/api/authorize/fuluusertoken','/api/Other/Verificationcode']; 
  // 获取数组是否在url里有
