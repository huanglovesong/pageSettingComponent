...
class MallLoginModalPageSetting extends React.Component {
    constructor(props) {
        super(props);
    ...
    componentWillReceiveProps(nextProps) {
        const { props } = this;
        const { loginPageSetting: { touristlogin, getCode } } = nextProps;
...
export default connect(mapStateToProps)(createForm()(MallLoginModalPageSetting));
